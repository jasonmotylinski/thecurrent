...
from pipelines.wyep.json_tasks import SaveDayJsonToLocal
        ...
        for p in json.load(input)["onToday"]:
                ...
                if records:
                    for s in records:
                        ...
                        yield[ create_id(played_at, s["artistName"], s["trackName"], config.WYEP.SERVICE_ID), 
                                s["artistName"],
                                s["trackName"],
                                album,
                                played_at.isoformat(),
                                s["_duration"], # Duration
                                config.WYEP.SERVICE_ID, # Service ID
                                '',
                                '',
                                '',
                                '',
